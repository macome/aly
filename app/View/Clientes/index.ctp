...
<div class="row">
			...
			<table class="table table-striped" cellpadding="0" cellspacing="0">
					<thead>
						<tr>
								...
								<th><?php echo $this->Paginator->sort('contacto_pessoal'); ?></th>
								<th><?php echo $this->Paginator->sort('contacto_alternativo'); ?></th>
				...
				<tbody>
					<?php foreach ($clientes as $cliente): ?>
						<tr>
							...
							<td><?php echo h($cliente['Cliente']['apelido']); ?>&nbsp;</td>
							<td><?php echo h($cliente['Cliente']['contacto_pessoal']); ?>&nbsp;</td>
							<td><?php echo h($cliente['Cliente']['contacto_alternativo']); ?>&nbsp;</td>
							<td><?php echo h($cliente['Cliente']['nuit']); ?>&nbsp;</td>
	...
	<div class="col-md-2">
		<ul class="list-group">
		  ...
		  <li class="list-group-item list-group-item-info"><?php echo $this->Html->link(__('New Cliente'), array('action' => 'add')); ?>
